class UsersController < ApplicationController
  ...
  before_filter :authenticate_admin, :except => [:change_password, :change_avatar, :update, :edit, :show, :index] # make sure logged in user is an admin
  before_filter :enable_admin_menu, :except => [:change_password, :change_avatar, :update, :edit, :show , :index]  # show admin menu
